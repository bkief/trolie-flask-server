...
class SnapshotSlim(Model):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.
    """

    def __init__(self, period_start=None, period_end=None, continuous_operating_limit=None, emergency_operating_limits=None):  # noqa: E501
        """SnapshotSlim - a model defined in OpenAPI

        :param period_start: The period_start of this SnapshotSlim.  # noqa: E501
        :type period_start: datetime
        :param period_end: The period_end of this SnapshotSlim.  # noqa: E501
        :type period_end: datetime
        :param continuous_operating_limit: The continuous_operating_limit of this SnapshotSlim.  # noqa: E501
        :type continuous_operating_limit: Limit
        :param emergency_operating_limits: The emergency_operating_limits of this SnapshotSlim.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'SnapshotSlim':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The snapshot-slim of this SnapshotSlim.  # noqa: E501
        :rtype: SnapshotSlim
        """
    ...
    def period_start(self) -> datetime:
        """Gets the period_start of this SnapshotSlim.
        ...
        :return: The period_start of this SnapshotSlim.
        :rtype: datetime
        """
    ...
    def period_start(self, period_start: datetime):
        """Sets the period_start of this SnapshotSlim.

         RFC 3339 date-time string with *no fractional seconds component* that designates a start or end to an operating period (such as an hour) that starts at a specified time. This will frequently be at the start of an hour, but may be finer-grained, such as every 30 minutes, should the Clearinghouse Provider choose.  If the Transmission Provider is operating in EST, these are valid and equivalent values:  * 2023-01-01T06:00Z * 2023-01-01T01:00-5:00 * 2023-01-01T00:00-6:00 * 2023-01-01T11:30+5:30  The server should uniformly represent date-times in the operational time zone of the Clearinghouse Provider.   # noqa: E501

        :param period_start: The period_start of this SnapshotSlim.
        :type period_start: datetime
        """
    ...
    def period_end(self) -> datetime:
        """Gets the period_end of this SnapshotSlim.

         RFC 3339 date-time string with *no fractional seconds component* that designates a start or end to an operating period (such as an hour) that starts at a specified time. This will frequently be at the start of an hour, but may be finer-grained, such as every 30 minutes, should the Clearinghouse Provider choose.  If the Transmission Provider is operating in EST, these are valid and equivalent values:  * 2023-01-01T06:00Z * 2023-01-01T01:00-5:00 * 2023-01-01T00:00-6:00 * 2023-01-01T11:30+5:30  The server should uniformly represent date-times in the operational time zone of the Clearinghouse Provider.   # noqa: E501

        :return: The period_end of this SnapshotSlim.
        :rtype: datetime
        """
    ...
    def period_end(self, period_end: datetime):
        """Sets the period_end of this SnapshotSlim.

         RFC 3339 date-time string with *no fractional seconds component* that designates a start or end to an operating period (such as an hour) that starts at a specified time. This will frequently be at the start of an hour, but may be finer-grained, such as every 30 minutes, should the Clearinghouse Provider choose.  If the Transmission Provider is operating in EST, these are valid and equivalent values:  * 2023-01-01T06:00Z * 2023-01-01T01:00-5:00 * 2023-01-01T00:00-6:00 * 2023-01-01T11:30+5:30  The server should uniformly represent date-times in the operational time zone of the Clearinghouse Provider.   # noqa: E501

        :param period_end: The period_end of this SnapshotSlim.
        :type period_end: datetime
        """
    ...
    def continuous_operating_limit(self) -> Limit:
        """Gets the continuous_operating_limit of this SnapshotSlim.


        :return: The continuous_operating_limit of this SnapshotSlim.
        :rtype: Limit
        """
    ...
    def continuous_operating_limit(self, continuous_operating_limit: Limit):
        """Sets the continuous_operating_limit of this SnapshotSlim.


        :param continuous_operating_limit: The continuous_operating_limit of this SnapshotSlim.
        :type continuous_operating_limit: Limit
        """
    ...
    def emergency_operating_limits(self) -> List[LimitValueSetInner]:
        """Gets the emergency_operating_limits of this SnapshotSlim.
        ...
        :return: The emergency_operating_limits of this SnapshotSlim.
    ...
    def emergency_operating_limits(self, emergency_operating_limits: List[LimitValueSetInner]):
        """Sets the emergency_operating_limits of this SnapshotSlim.

         A set of general limit or rating values, each mapped to the various limit bands defined by the Transmission Provider's operating manual. This typically consists of a \"normal\" limit, as well as limits for various levels of emergency conditions (typically 2-4) defined in the operations manual.   # noqa: E501

        :param emergency_operating_limits: The emergency_operating_limits of this SnapshotSlim.
        :type emergency_operating_limits: List[LimitValueSetInner]
        """
